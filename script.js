document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        vi: {
            ...
            skill_hosting_desc: 'Quản trị và setup VPS Server, cPanel cùng các Web Panel đa dạng. Tích hợp Cloudflare (DNS, CDN, Security). Cấu hình Web Server, bảo mật SSL/HTTPS, Webmail và hệ thống sao lưu dữ liệu.',
